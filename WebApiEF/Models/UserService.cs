...
namespace WebApiEF.Models
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<bool> T()
        {
            ...
            //Seed Default User
            //var defaultUser = new ApplicationUser { FirstName = "First", LastName = "Last", UserName = Authorization.default_username, Email = Authorization.default_email, EmailConfirmed = true, PhoneNumberConfirmed = true };

            //if (_userManager.Users.All(u => u.Id != defaultUser.Id))
            //{
            //    await _userManager.CreateAsync(defaultUser, Authorization.default_password);
